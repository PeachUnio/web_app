...
from catalog.views import HomeView, ContactsView, ProductsDitail, ProductsCreateView, ProductUpdateView, ProductDeleteView, CategoryListView, ProductsByCategoryView
...
urlpatterns = [
    ...
    path('category/<slug:category_slug>/', ProductsByCategoryView.as_view(), name='products_by_category'),
]
